...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_cmd.add_argument("--mode", choices=["generated", "internet", "intelligence", "linkmaze"], default="generated", help="Puzzle source mode")
    ...
    batch_cmd.add_argument("--mode", choices=["generated", "internet", "intelligence", "linkmaze"], default="generated")
